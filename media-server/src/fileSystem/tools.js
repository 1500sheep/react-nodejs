...
module.exports = {
  realIp: function * (next) {
      ...
      console.log("tools.js realIp(), this.req.ip : ",this.req.ip);
      yield *next;
  },
  ...
  loadRealPath: function *(next) {
    ...
    // this.request.fPath = "http://localhost:7402/media";
    console.log("tools.js loadRealPath(), this.request.fPath : ",this.request.fPath);
